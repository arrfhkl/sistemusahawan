...
$sql = "SELECT nama, alamat, telefon, jenis, perniagaan FROM usahawan";
...
<head>
    ...
    <title>Senarai Usahawan - Sistem Usahawan Pahang</title>
...
@keyframes metalshine {
  ...
  100% { background-position: 0% 50%; }
        ...
        .card { background: white; padding: 20px; margin: 10px 0; border-radius: 8px; border: 1px solid #ccc; transition: transform 0.3s, box-shadow 0.3s; }
        .card:hover { transform: scale(1.02); box-shadow: 0 6px 12px rgba(0,0,0,0.12); }

        /* ===== Table ===== */
        table { width: 100%; border-collapse: collapse; margin-top: 15px; }
        table, th, td { border: 1px solid #ccc; }
        th { background: #b0b0b0; color: white; padding: 10px; }
        td { padding: 8px; background-color: white; }
  ...
  .function-btn { padding: 15px; }
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            const correctCode = "12345"; // 🔹 Security code you want
            let userCode = prompt("Masukkan kod keselamatan untuk mengakses halaman ini:");
            if (userCode !== correctCode) {
                alert("Kod salah! Anda akan dialihkan keluar.");
...
<header>
  ...
  <nav id="navMenu">
    ...
    <a href="senarai.php" class="active"><strong>Senarai Usahawan</strong></a>
  </nav>
</header>

<div class="container">
    <div class="card">
        <h2>Senarai Usahawan</h2>
        <table>
            <tr>
                <th>Nama</th>
                <th>Alamat</th>
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr><td colspan='5'>Tiada rekod usahawan.</td></tr>";
            }
            ?>
        </table>
    </div>
