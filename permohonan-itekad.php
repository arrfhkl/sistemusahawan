...
<head>
  ...
  <title>Permohonan Geran i-TEKAD - Sistem Usahawan Pahang</title>
...
.form-header {
  ...
  margin-bottom: 35px;
  padding-bottom: 20px;
  border-bottom: 2px solid rgba(0, 68, 255, 0.2);
}
...
.section-title {
  ...
  margin-bottom: 20px;
  padding-bottom: 10px;
  border-bottom: 1px solid rgba(0, 68, 255, 0.15);
  display: flex;
  align-items: center;
  gap: 10px;
}
...
/* ===== Info Box ===== */
.info-box {
  background: linear-gradient(135deg, rgba(0, 68, 255, 0.05) 0%, rgba(0, 68, 255, 0.02) 100%);
...
<div class="container">
  <div class="card">
    <div class="form-header">
      ...
      <h2>Permohonan Geran i-TEKAD</h2>
    ...
    <div class="info-box">
      ...
      <p><strong>Nota Penting:</strong> Geran i-TEKAD adalah bantuan kewangan antara RM1,000 hingga RM5,000 untuk golongan B40 dan Asnaf yang ingin memulakan perniagaan. Semua medan bertanda <span class="required">*</span> adalah wajib diisi.</p>
    </div>

    <form action="simpan_itekad.php" method="POST" enctype="multipart/form-data">
