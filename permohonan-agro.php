...
@keyframes metalshine {
  ...
  100% { background-position: 0% 50%; }
    ...
    h2 { margin-bottom: 20px; color: #0044ffff; }
...
<div class="container">
  <div class="card">
    <h2><i class="fas fa-leaf"></i> Permohonan Geran Agroprenur Muda</h2>
    <p>Sila lengkapkan borang di bawah untuk membuat permohonan Geran Agropreneur Muda</p>
    ...
    <form action="simpan-agro.php" method="POST" enctype="multipart/form-data">
      ...
      <input type="text" id="ic" name="ic" required pattern="[0-9]{12}" placeholder="Contoh: 010203031234">
      ...
      <label for="projek">Jenis Projek</label>
      ...
      <input type="number" id="jumlah" name="jumlah" min="1000" max="20000" required>

      <label for="tujuan">Tujuan Permohonan</label>
      <textarea id="tujuan" name="tujuan" rows="3" required></textarea>

      <label for="dokumen">Muat Naik Dokumen Sokongan (PDF/JPG/PNG)</label>
