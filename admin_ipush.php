...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["id"], $_POST["status"])) {
    ...
    $conn->query("UPDATE permohonan_ipush SET status='$status' WHERE id=$id");
    echo "success";
    exit;
}

// ====== PAGINATION ======
$limit = 15; // jumlah rekod per halaman
$page = isset($_GET['page']) ? (int)$_GET['page'] : 1;
if ($page < 1) $page = 1;
$offset = ($page - 1) * $limit;

// Kira jumlah rekod
$total_records_result = $conn->query("SELECT COUNT(*) AS total FROM permohonan_ipush");
...
<head>
  ...
  <title>Permohonan iPush - Sistem Usahawan Pahang</title>
  <style>
    :root {
      --primary: #003366;
      --secondary: #0055a5;
...
<body>
  ...
  <div class="main-content">
    <header>
      <h1>Senarai Permohonan iPush</h1>
    ...
    <div class="table-container">
      ...
      <div class="pagination">
        ...
        <?php if ($page < $total_pages): ?>
          <a href="?page=<?= $page + 1; ?>">Seterusnya &raquo;</a>
        <?php endif; ?>
      </div>
    </div>
